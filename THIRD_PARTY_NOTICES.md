...
The `aegis-operations` source is MIT licensed. The following bundled artifacts retain their
...
- Upstream: [Splunk Attack Data](https://github.com/splunk/attack_data)
...
[SigmaHQ repository](https://github.com/SigmaHQ/sigma) and licensed under the Detection
Rule License 1.1 (`DRL-1.1`). The curated pack covers Windows process creation and process
